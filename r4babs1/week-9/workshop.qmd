...
Now we will create a word document with some text and figures. I find the best way to include figures in a word document is to use a table with the borders turned off. This can make it easier to control the layout. This is what you are aiming for: 
...
![](images/do_on_your_computer.png) Hold down the control key and click on each of the borders until all are selectedd. Then use the Border Width icon to set the width to 0pt
