...
# import files used in the homework
...
4.  💻 Amend this code to change the order of the bars by the average mass of each coat colour? [Changing the order of bars](r4babs1/week-7/workshop.html#changing-the-order-of-bars) was covered last week. You may also want to practice formatting the graph nicely.
