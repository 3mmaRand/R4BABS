...
Navigate to the `data-analysis-in-r-1` folder and name the RStudio Project `week-8`.
...
Do you remember [Look after future you!](../week-7/workshop.html#look-after-future-you)
...
You may want to refer to [Checking assumptions](../week-6/workshop.html#checking-assumptions) in the "Single regression" workshop.
...
You may need to refer to [Visualise](../week-4/workshop.html#visualise) from the "Summarising data with several variables" workshop [@rand2023]
