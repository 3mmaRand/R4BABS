...
[Importing data from
files](../week-3/workshop.html#importing-data-from-files) was
...
cats](../week-3/workshop.html#cat-mass) using this method.
...
assessment for BIO00052M Data Analysis in R is to
submit an RStudio Project You will zip up the RStudio Project folder 
and submit it to the VLE. That folder should contain all the data, 
code and figures you have used in your report and all of the results 
