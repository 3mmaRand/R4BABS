...
[Changing the
axes](../week-2/workshop.html#changing-the-axes) from the
Week 2 workshop [@rand2023]
...
#---BONUS CODING ANSWER---
# I'm not expecting you to know about this but it's a neat trick. 
# The glue package allows
# us to use R objects in strings so their values are printed. The R object
# is put in curly brackets.
ggplot(plant, aes(x = day, y = mass)) +
  geom_point() +
  geom_smooth(method = "lm", 
              se = FALSE, 
...
-   edit your comments for clarity and include a paragraph explaining
    ...
    add code section headers (Ctrl+Shift+R)
...
You will find it useful to change some options in RStudio to make
your life easier. Revisit [Changing some defaults to make life easier](https://3mmarand.github.io/comp4biosci/first-steps-rstudio.html#changing-some-defaults-to-make-life-easier).

If you need to make additional notes that do not belong in the script,
you can add them a text file called `README.txt` that future you -- and anyone
else will know exactly what to do with!
