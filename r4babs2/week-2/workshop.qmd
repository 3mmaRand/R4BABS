...
![](images/do_in_R.png) Create a figure with using both `geom_point()` and `geom_smooth()`

NEED TO BUILD THIS UP FROM START AND REFER TO PREVIOUS WORK
...
![](images/do_in_R.png) Can you workout how to add the equation of the line to the figure like this?
