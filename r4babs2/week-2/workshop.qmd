...
```
 ...
 ![](images/do_in_R.png) The `geom_smooth()` function will had a variety of fited lines to a plot. We want a line so we need to specify `method = "lm"`:
...
#| fig-cap: "The relationship between days after planting and the mass of a plant. "
