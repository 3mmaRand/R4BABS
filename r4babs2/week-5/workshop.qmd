...
You will get a message that you don't need to worry about
summarise()`has grouped output by 'BrainRegion'. You can override using the`.groups`argument.>`
...
Now we need to add the statistical result. You can remind yourself 
how to do that by looking at [the week 3 workshop](../week-3/workshop.html#illustrating). Remember, the lines go
...
[View the Qmd in
Browser](https://github.com/3mmaRand/R4BABS/blob/main/r4babs2/week-5/workshop.qmd).
