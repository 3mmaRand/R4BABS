...
-   know what functions are used in R to run these tests and how to
    interpret them

-   evaluate whether the assumptions of `lm()` are met

-   scientifically report the results of these tests including
    appropriate figures
...
3.  [Consolidate](study_after_workshop.qmd)
    ...
    i.  💻 Appropriately test if fitness and acclimation effect the
        sodium content of sweat
    ii. 💻 Appropriately test if insecticides vary in their
        effectiveness
