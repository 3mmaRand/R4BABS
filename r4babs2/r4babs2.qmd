...
-   Think creatively to address a Grand Challenge by designing investigations 
    with testable hypotheses and rigorous controls

-   Appropriately select classical univariate statistical tests and some 
    non-parametric equivalents to a given scenario and recognise when these
    are not suitable

-   Use R to perform these analyses, reproducibly, on data in a variety of 
    formats and present the results graphically
