...
wide format to long format. It takes all columns except `transcript` (`cols = -transcript`) and gathers them into two new columns:

  - `"sample"` → Stores the original column names 
     (`SCK14_1`, `SCK14_2`, etc.).
