...
| concepts.                     |                               |
|                               | Do not **uncritically         |
| It is OK to use an AI to      | accept** code modifications   |
| **modify** your code but you  | without evaluating their      |
| must understand the inputs,   | accuracy or relevance.        |
| the outputs and what the code |                               |
| does. This is important       | Do not use an AI to           |
| because AIs like to add       | **generate** comments.        |
| things you don't need and the |                               |
| marking scheme takes account  |                               |
| relevance.                    |                               |
|                               |                               |
| Do [Acknowledge and           |                               |
| reference](https://subjec     |                               |
| tguides.york.ac.uk/referencin |                               |
| g-style-guides/generative-ai) |                               |
| generative AI (you should     |                               |
| also acknowledge and          |                               |
| reference other sources of    |                               |
| code such as workshop, text   |                               |
