...
🎬 The sample data had [22 columns](../week-2/workshop.html#explore-the-data-structure). We used [meta.csv](../week-2/data-meta/meta.csv) to rename the columns. Some of those columns were not used and we [dropped them](../week-2/workshop.html#drop-the-unused-channels-columns). You data has been created without those columns. You will therefore use a different [meta.csv](../week-2/data-meta/meta.csv) file and you will **not** need to drop any columns.
