...
-   import `fcs` files, explain a "flowFrame" and a "flowSet" and access the column 
    names and data in them

-   apply automated quality control to a flowSet with the **`flowAI`** package

-   explain why we use the "logicle" transformation and apply it to appropriate 
    channels

-   cast the data into a dataframe to use standard tools for filtering, 
    summarising and plotting data

-   explain the purpose of gating and apply appropriate gates to flow cytometry
    data
...
3.  [Consolidate](study_after_workshop.qmd)
    ...
    i. 💻 Set up your RStudio Project for the analysis of your own data.
