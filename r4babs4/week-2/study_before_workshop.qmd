...
1.  Week 2 Data Analysis 2: Immunobiology - Sample data analysis

2.  Week 4 Data Analysis 3: Immunobiology - Analysis of your own data

3.  Week 6 Data Analysis 4: Immunobiology - Customising figures
...
-   Prepare you for the sample data analysis workshop but the design and analysis
    are the same as for your own data

-   Summarise the experimental design and aims

-   Explain what the data are

-   Go through the analytical steps are conceptually
...
-   We only expect to see green fluorescence (APC) if the treatment is *E. coli*
...
-   Apply a "logicle" transformation to the fluorescence channels (similar to logging)
...
-   Import, rename and subset columns using the **`flowCore`** package

-   Automated quality control with the **`flowAI`** package

-   Apply a "logicle" transformation using the **`flowCore`** package

-   Put the data into a dataframe to make it easy to use **`tidyverse`** tools like
