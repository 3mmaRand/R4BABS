...
-   Prepare you for the workshop analysing the sample data.... and your
    own data, which is in the same format
...
-   the 16 columns: TIME, Time MSW, Pulse Width, FS Lin, FS Area, FS
    Log, SS Lin, SS Area, SS Log, FL 1 Lin, FL 1 Area, FL 1 Log, FL 8
    Lin, FL 8 Area, FL 8 Log, Event Count
...
-   3 treatments x 2 antibodies = 6 combinations; 4 variables up to
    50000 cells each
